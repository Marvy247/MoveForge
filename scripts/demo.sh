...
# MoveForge Demo Script - Clean Output Version
...
if [ ! -f "$MOVEFORGE" ]; then
    echo "Error: MoveForge binary not found. Run: cargo build --release"
    exit 1
fi
...
echo ""
echo "MoveForge - Foundry-grade testing toolkit for Movement"
echo "GitHub: github.com/moveforge/moveforge"
